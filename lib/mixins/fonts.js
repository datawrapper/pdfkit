...
export default {
  ...
  font(src, family, size) {
    ...
    // get the font name from the loaded font if the font was passed as a buffer
    if (!name) {
      // ignore name "-", because it's not unique enough and can lead to a
      // collision
      if (this._font.name && this._font.name !== '-') {
